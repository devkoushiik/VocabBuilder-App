...
export const darkTheme = {
  ...
  // Flashcard
  flashcardBg: '#0D0D0D', // Near black - match card
  flashcardBorder: '#1A1A1A', // Very dark gray border
  flashcardLabel: '#FF0000', // Pure Red accent
  flashcardValue: '#FFFFFF', // Pure White
  flashcardHint: '#FF3333', // Light red
